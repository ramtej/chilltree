    ...
    <>
      ...
      <section className="image-section" style={{ minHeight: '100vh', position: 'relative' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(10, 10, 15, 0.85) 0%, rgba(15, 15, 26, 0.75) 25%, rgba(26, 26, 46, 0.65) 50%, rgba(10, 10, 15, 0.95) 100%)',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle at 30% 20%, rgba(255, 215, 0, 0.15) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(0, 255, 255, 0.12) 0%, transparent 50%)',
...
<span style={{
      ...
      <section className="image-section premium-section" style={{ minHeight: '80vh' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(10, 10, 15, 0.9) 0%, rgba(15, 15, 26, 0.85) 50%, rgba(26, 26, 46, 0.8) 100%)',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle at 40% 30%, rgba(255, 215, 0, 0.12) 0%, transparent 60%), radial-gradient(circle at 60% 70%, rgba(0, 255, 255, 0.08) 0%, transparent 60%)',
